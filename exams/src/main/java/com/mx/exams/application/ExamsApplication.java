package com.mx.exams.application;
 ...
 */
public class ExamsApplication extends BaseApplication {

    public static Context applicationContext;
    private static ExamsApplication instance;

    public static ExamsApplication getInstance() {
        return instance;
    }
