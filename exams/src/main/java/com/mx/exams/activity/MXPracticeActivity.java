...
import com.mx.exams.adapter.TimeTableCourseAdapter;
...
import com.mx.exams.view.TagBaseAdapter;
import com.mx.exams.view.TagCloudLayout;
...
public class MXPracticeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        recyclerKemu.setLayoutManager(new GridLayoutManager(this, 4));
    ...
    private List<HistoryModel> parseHistoryData(String data) {
        ...
        try {
            ...
            APPLog.e("parseHistoryData",data);
