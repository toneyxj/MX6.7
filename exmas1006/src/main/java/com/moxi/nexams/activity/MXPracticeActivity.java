...
import com.moxi.nexams.adapter.TimeTableCourseAdapter;
...
import com.moxi.nexams.model.ChoseResultModel;
...
import com.moxi.nexams.view.TagBaseAdapter;
import com.moxi.nexams.view.TagCloudLayout;
            ...
            gridExams.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    if (has != null && has.equals("0")) {
                        Intent paper = new Intent(MXPracticeActivity.this, MXPaperIndexActivity.class);
                        ...
                        OkHttpUtils.get().url(urlbase + downIndex + ".db").build().execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "nexams/dbdata/" + downIndex + ".db") {
                            ...
                            public void onError(Call call, Exception e, int id) {
                                dialogShowOrHide(false, "请稍后...");
                                Toastor.showToast(MXPracticeActivity.this, "下载失败");
                            ...
                            public void onResponse(File response, int id) {
                                dialogShowOrHide(false, "请稍后...");
                                Toastor.showToast(MXPracticeActivity.this, "下载成功");
