...
public class MuPDFReaderView extends ReaderView {
    ...
    PageFling flyListener;
    public void setPageFlyListener(PageFling listener){
        this.flyListener=listener;
    }
        ...
        if (mMode == Mode.Viewing && !tapDisabled) {
            ...
            if (item == Hit.Nothing) {
                if (mLinksEnabled && pageView != null
                    ...
                    Log.e("mupdfreadview:","左滑");
                } else if (e.getX() > super.getWidth() - tapPageMargin) {
                    super.smartMoveForwards();
                    Log.e("mupdfreadview:","右滑");
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
        ...
        if (Math.abs(e1.getX() - e2.getX()) > Math.abs(e1.getY()
            ...
            if (e1.getX() - e2.getX() > 100) {
                Log.e("onFling:","下一页");
                moveToNext();
                flyListener.doFly(getDisplayedViewIndex(),1);
                return true;
            }
            // 右滑
                ...
                Log.e("onFling:","上一页");
                moveToPrevious();
                flyListener.doFly(getDisplayedViewIndex(),0);
                return true;
            }
        }
        return true;
