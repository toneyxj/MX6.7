...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    protected View mHeaderOtherView;//头部其它view
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int otherViewResId = a.getResourceId(R.styleable.PullToZoomView_headerOtherView, 0);
            if (otherViewResId > 0) {
                mHeaderOtherView = mLayoutInflater.inflate(otherViewResId, null, false);
            }
    ...
    public abstract void setHeaderOtherView(View otherView);
